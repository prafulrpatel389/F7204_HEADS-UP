            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.nav_status:
                        startActivity(new Intent(MainActivity.this, Status
                                .class));
                        break;
                    case R.id.nav_articles:
                        startActivity(new Intent(MainActivity.this, Articles
                                .class));
                        break;
                    case R.id.nav_groups:
                        startActivity(new Intent(MainActivity.this, Groups
                                .class));
                        break;
                    case R.id.nav_profile:
                        startActivity(new Intent(MainActivity.this, Profile
                                .class));
                        break;
                    case R.id.nav_setting:
                        startActivity(new Intent(MainActivity.this, Setting
                                .class));
                        break;
                    case R.id.nav_logout:
                        startActivity(new Intent(MainActivity.this, Initial
                                .class));
                        break;
                }
                return true;
